    ...
    <div class="abstract-item-header">
      <div class="abstract-item-title">
        <i class="abstract-item-icon"
           ...
           :class="abstract.title|fileName"></i>
      ...
      <!--<div class="abstract-item-handle" v-if="abstract.file"><i class="el-icon-download"></i>下载</div>
      <div class="abstract-item-handle" v-if="abstract.file">主文档</div>-->
    </div>
