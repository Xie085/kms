...
VALUES (2000, 'KMS知识管理', 0, 1, 'kms', '', NULL, 1, 0, 'M', '0', '0', '', 'education', 'admin',
        '2022-05-22 16:01:06', 'admin', '2022-09-07 11:18:04', '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2001, '知识管理', 2000, 1, 'kms', 'kms/index', NULL, 1, 0, 'C', '0', '0', '', 'education', 'admin',
        '2022-05-22 16:01:50', 'admin', '2022-09-06 09:59:20', '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2003, '目录管理', 2000, 1, 'catalog', 'kms/catalog/index', NULL, 1, 0, 'C', '0', '0', 'kms:catalog:list',
        'list', 'admin', NULL, 'admin', '2022-09-06 09:58:58', '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2004, '知识检索系统', 0, 0, '/kms/search', '/kms/search', NULL, 1, 0, 'C', '0', '0', '', 'dict', 'admin',
        '2022-09-07 11:17:05', 'admin', '2022-09-07 11:18:22', '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2011, '流程模板', 2010, 1, 'activiti', 'activiti/index', NULL, 1, 0, 'C', '0', '0', '', 'example', 'admin',
        '2022-09-30 14:28:12', 'admin', '2022-10-01 12:02:35', '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2010, '流程管理', 0, 1, 'activiti', NULL, NULL, 1, 0, 'M', '0', '0', '', 'example', 'admin',
        '2022-09-30 13:48:08', 'admin', '2022-10-01 12:01:46', '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2009, '查看所有知识', 2001, 5, '', NULL, NULL, 1, 0, 'F', '0', '0', 'kms:main:viewAll', '#', 'admin',
        '2022-09-13 11:24:41', '', NULL, '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2008, '知识删除', 2001, 2, '', '', '', 1, 0, 'F', '0', '0', 'kms:main:remove', '#', 'admin',
        '2022-05-22 15:25:08', '', NULL, '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2007, '知识编辑', 2001, 2, '', '', '', 1, 0, 'F', '0', '0', 'kms:main:edit', '#', 'admin',
        '2022-05-22 15:25:08', '', NULL, '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2006, '知识新增', 2001, 2, '', '', '', 1, 0, 'F', '0', '0', 'kms:main:add', '#', 'admin', '2022-05-22 15:25:08',
        '', NULL, '');
INSERT INTO sys_menu(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`,
                     `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`,
                     `update_by`, `update_time`, `remark`)
VALUES (2005, '知识查询', 2001, 1, '', '', '', 1, 0, 'F', '0', '0', 'kms:main:query', '#', 'admin',
        '2022-05-22 15:25:08', '', NULL, '');
-- ----------------------------
-- 6、用户和角色关联表  用户N-1角色
-- ----------------------------
