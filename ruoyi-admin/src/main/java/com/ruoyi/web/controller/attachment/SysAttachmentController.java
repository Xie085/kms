package com.ruoyi.web.controller.attachment;
...
public class SysAttachmentController extends BaseController {
    @Autowired
    private ISysAttFileService sysAttFileService;

    @Autowired
    private ISysAttMainService sysAttMainService;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            ...
            // 上传并返回新文件名称
            Map<String, String> map = sysAttFileService.upload(filePath, file);
            String attMainId = map.get("attMainId");
