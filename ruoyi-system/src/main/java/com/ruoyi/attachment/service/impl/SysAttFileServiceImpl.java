...
public class SysAttFileServiceImpl implements ISysAttFileService {
     ...
     */
    public Map<String, String> upload(String baseDir, MultipartFile file, String[] allowedExtension)
            throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException,
            InvalidExtensionException {

        return saveAttFile(baseDir, file, allowedExtension);
    }

    private Map<String, String> saveAttFile(String baseDir, MultipartFile multipart, String[] allowedExtension) throws IOException, InvalidExtensionException {
        ...
        String fileName = FileUploadUtils.extractFilename(multipart);
